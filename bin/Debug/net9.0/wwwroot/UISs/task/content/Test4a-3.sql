...
(1, 'One', 'Dam'), (2, 'Two', 'Dum'), 
(3, 'Three', 'Dym'), (4, 'Four', 'Dom'), 
(5, 'Five', 'Dan'), (6, 'Six', 'Dam'), 
(7, 'Seven', 'Dum'), (8, 'Eight', 'Dim'), 
(9, 'Nine', 'Dak')
...
(2, 'Two', 'Dum'), (3, 'Three', 'Dym'), 
(4, 'Four', 'Dom'), (5, 'Five', 'Dan'), 
(6, 'Six', 'Dam'), (10, 'Ten', 'Der'), 
(11, 'Eleven', 'Dan'), (12, 'Twelve', 'Del'), 
(14, 'Fourteen', 'Dak')

SELECT tone.ID, tone.Text1, tone.Text2
FROM dbo.TestSelectOne AS tone
LEFT JOIN dbo.TestSelectTwo AS ttwo ON tone.ID=ttwo.ID 
WHERE ttwo.ID IS NULL